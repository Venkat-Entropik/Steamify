...
const HomePage = () => {
  ...
  return (
    <div data-testid="home-page" className="min-h-screen bg-base-100 pb-20">
          ...
          <div className="flex flex-col md:flex-row items-end justify-between gap-6 mb-12">
            <div className="space-y-2">
              <h1 className="text-4xl md:text-5xl font-black tracking-tight">
                {t("home.yourConnections")}
              </h1>
              <p className="text-base-content/60 text-lg">
                {t("home.connectionsSubtitle")}
              </p>
            </div>
            <Link
              to="/notifications"
              className="btn btn-primary btn-md gap-2 rounded-2xl shadow-lg shadow-primary/20"
            >
